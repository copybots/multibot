...
async def on_ready_code(bot):
	...
	if bot.unique_id == "001":
		...
		globaldata[bot.unique_id]["filedata"] = {"setup_info" : {"copy_server_ids" : ["456445523960791042"], "copy_channel_ids" : ["484138416276111375"], "post_server_ids" : ["478003659519688704", "455268032571244545"], "post_channel_ids" : ["482330384290414627",  "484111269893373974", "486865420952010783"]}, "memberlist" : ["454205578537861121", "245365926080413696"], "wordlist" : ["@", "!", "-30", "+9", "+8", "+7", "+6", "+5", "+4", "reacted with the correct answer", "reacted with the incorrect answer"], "case_sensitive_wordlist" : True, "header_text": "", "footer_text": "", "footer_icon": ""}
